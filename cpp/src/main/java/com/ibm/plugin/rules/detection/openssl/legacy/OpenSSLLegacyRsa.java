...
public final class OpenSSLLegacyRsa {
    ...
    private static final IDetectionRule<AstNode> RSA_NEW =
    ...
    private static final IDetectionRule<AstNode> RSA_SIGN_ASN1_OCTET_STRING =
            new DetectionRuleBuilder<AstNode>()
                    .createDetectionRule()
                    .forObjectTypes("*")
                    .forMethods("RSA_sign_ASN1_OCTET_STRING")
                    .shouldBeDetectedAs(new ValueActionFactory<>("RSA-SIGN"))
                    .withAnyParameters()
                    .buildForContext(new SignatureContext(SignatureContext.Kind.NONE))
                    .inBundle(() -> BUNDLE)
    ...
    private static final IDetectionRule<AstNode> RSA_VERIFY_ASN1_OCTET_STRING =
            new DetectionRuleBuilder<AstNode>()
                    .createDetectionRule()
                    .forObjectTypes("*")
                    .forMethods("RSA_verify_ASN1_OCTET_STRING")
                    .shouldBeDetectedAs(new ValueActionFactory<>("RSA-VERIFY"))
                    .withAnyParameters()
                    .buildForContext(new SignatureContext(SignatureContext.Kind.NONE))
                    .inBundle(() -> BUNDLE)
    ...
    private static final IDetectionRule<AstNode> RSA_CHECK_KEY =
            new DetectionRuleBuilder<AstNode>()
                    .createDetectionRule()
                    .forObjectTypes("*")
                    .forMethods("RSA_check_key")
                    .shouldBeDetectedAs(new ValueActionFactory<>("RSA"))
                    .withAnyParameters()
                    .buildForContext(new KeyContext(KeyContext.Kind.NONE))
                    .inBundle(() -> BUNDLE)
    ...
    private static final IDetectionRule<AstNode> RSA_CHECK_KEY_EX =
            new DetectionRuleBuilder<AstNode>()
                    .createDetectionRule()
                    .forObjectTypes("*")
                    .forMethods("RSA_check_key_ex")
                    .shouldBeDetectedAs(new ValueActionFactory<>("RSA"))
                    .withAnyParameters()
                    .buildForContext(new KeyContext(KeyContext.Kind.NONE))
                    .inBundle(() -> BUNDLE)
