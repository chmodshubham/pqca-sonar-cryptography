...
public final class InitializationVectorLength extends Property {
    @Nonnull private final Integer value; // in bit

    public InitializationVectorLength(
            @Nonnull Integer value, @Nonnull DetectionLocation detectionLocation) {
        super(InitializationVectorLength.class, detectionLocation);
        this.value = value;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof InitializationVectorLength initializationVectorLength))
            return false;
        if (!super.equals(object)) return false;
        return Objects.equals(value, initializationVectorLength.value);
    }
