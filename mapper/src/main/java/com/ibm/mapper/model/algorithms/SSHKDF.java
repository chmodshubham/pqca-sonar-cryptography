 ...
 *
 * <ul>
 *   <li>https://datatracker.ietf.org/doc/html/rfc4253#section-7.2
 * </ul>
 *
 ...
 * </ul>
 */
public final class SSHKDF extends Algorithm implements KeyDerivationFunction {

    private static final String NAME = "SSHKDF";

    public SSHKDF(@Nonnull DetectionLocation detectionLocation) {
        super(NAME, KeyDerivationFunction.class, detectionLocation);
    }

    public SSHKDF(@Nonnull MessageDigest messageDigest) {
