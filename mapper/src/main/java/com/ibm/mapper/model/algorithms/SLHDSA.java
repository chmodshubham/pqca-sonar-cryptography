 ...
 *
 * <ul>
 *   <li>Stateless Hash-Based Digital Signature
 *   <li>Standardized version of SPHINCS+
 * </ul>
 */
public class SLHDSA extends Algorithm implements Signature {
    ...
    public SLHDSA(@Nonnull DetectionLocation detectionLocation) {
        super(NAME, Signature.class, detectionLocation);
    }

    public SLHDSA(@Nonnull MessageDigest preHash) {
        this(preHash.getDetectionContext());
        this.put(preHash);
    }

    public SLHDSA(int parameterSetIdentifier, @Nonnull DetectionLocation detectionLocation) {
    ...
    public SLHDSA(int parameterSetIdentifier, @Nonnull MessageDigest preHash) {
        this(preHash.getDetectionContext());
        this.put(preHash);
        this.put(
                new ParameterSetIdentifier(
