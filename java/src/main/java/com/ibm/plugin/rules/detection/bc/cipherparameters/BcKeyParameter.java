...
public final class BcKeyParameter {

    private BcKeyParameter() {
        // nothing
    }
    ...
    private static final IDetectionRule<Tree> CONSTRUCTOR_1 =
            new DetectionRuleBuilder<Tree>()
                    .createDetectionRule()
                    /* Using "exact types" because KeyParameter is a parent class */
                    .forObjectExactTypes("org.bouncycastle.crypto.params.KeyParameter")
                    .forConstructor()
