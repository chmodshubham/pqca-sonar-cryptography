...
public final class SSLParametersSetProtocols {

    private static final IDetectionRule<Tree> SSL_SET_PROTOCOLS =
            new DetectionRuleBuilder<Tree>()
                    .createDetectionRule()
                    .forObjectExactTypes("javax.net.ssl.SSLParameters")
                    .forMethods("setProtocols")
