...
class JcaKeyAgreementGenerateSecretKeySizeTest extends TestBase {

    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/jca/keyagreement/JcaKeyAgreementGenerateSecretKeySizeTestFile.java")
                .withChecks(this)
                .verifyIssues();
    }
    ...
    public void asserts(
        ...
        assertThat(keySize.getDetectionValues()).anyMatch(v -> v.asString().equals("2048"));
