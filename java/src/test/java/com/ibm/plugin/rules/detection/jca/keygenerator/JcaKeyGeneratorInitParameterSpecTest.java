...
class JcaKeyGeneratorInitParameterSpecTest extends TestBase {

    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/jca/keygenerator/JcaKeyGeneratorInitParameterSpecTestFile.java")
                .withChecks(this)
                .verifyIssues();
    }
