...
class BcMLDSASignerTest extends TestBase {

    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile("src/test/files/rules/detection/bc/signer/BcMLDSASignerTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("MLDSASigner");
        ...
        assertThat(value0_1_1.asString()).isEqualTo("ml_dsa_44");
        ...
        assertThat(signatureNode.asString()).isEqualTo("ML-DSA-44");
        ...
        assertThat(oidNode.asString()).isEqualTo("2.16.840.1.101.3.4.3.17");
