...
class BcKGCMBlockCipherTest extends TestBase {
    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/bc/aeadcipher/BcKGCMBlockCipherTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("KGCMBlockCipher");
