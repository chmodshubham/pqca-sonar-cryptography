...
class BcMLKEMExtractorTest extends TestBase {

    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/bc/encapsulatedsecret/BcMLKEMExtractorTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("MLKEMExtractor");
        ...
        assertThat(value0_1.asString()).isEqualTo("ml_kem_512");
        ...
        assertThat(keyEncapsulationMechanismNode.asString()).isEqualTo("ML-KEM-512");
        ...
        assertThat(oidNode.asString()).isEqualTo("2.16.840.1.101.3.4.4.1");
        ...
        assertThat(parameterSetIdentifierNode.asString()).isEqualTo("512");
    }
}
