...
class BcCCMBlockCipherTest extends TestBase {
    @Test
    void test() {
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("CCMBlockCipher");
        ...
        assertThat(authenticatedEncryptionNode.asString()).isEqualTo("AES-CCM");
        ...
        assertThat(modeNode.asString()).isEqualTo("CCM");
