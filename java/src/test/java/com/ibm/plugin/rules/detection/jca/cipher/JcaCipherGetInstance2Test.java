...
class JcaCipherGetInstance2Test extends TestBase {

    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/jca/cipher/JcaCipherGetInstance2TestFile.java")
                .withChecks(this)
                .verifyIssues();
    }
    ...
    public void asserts(
        ...
        assertThat(padding.asString()).isEqualTo("PKCS5");
