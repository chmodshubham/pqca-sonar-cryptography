...
class BcPaddedBufferedBlockCipherTest extends TestBase {
    ...
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/bc/bufferedblockcipher/BcPaddedBufferedBlockCipherTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("PaddedBuffered");
        ...
        /*
         * Expect 3 ValueActions:
         * 1 - CBC
         * 2 - PKCS7
         * 3 - AES (as child of CBC)
         */
