...
class BcHashMLDSASignerTest extends TestBase {

    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile("src/test/files/rules/detection/bc/signer/BcHashMLDSASignerTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("HashMLDSASigner");
        ...
        DetectionStore<JavaCheck, Tree, Symbol, JavaFileScannerContext> store_1_1 =
                getStoreOfValueType(AlgorithmParameter.class, store_1.getChildren());
        ...
        assertThat(value0_1_1).isInstanceOf(AlgorithmParameter.class);
        assertThat(value0_1_1.asString()).isEqualTo("ml_dsa_44_with_sha512");
        ...
        assertThat(signatureNode.asString()).isEqualTo("SHA512withML-DSA-44");

        // Oid under Signature
        INode oidNode = signatureNode.getChildren().get(Oid.class);
        assertThat(oidNode).isNotNull();
        assertThat(oidNode.getChildren()).isEmpty();
        assertThat(oidNode.asString()).isEqualTo("2.16.840.1.101.3.4.3.32");
        ...
        assertThat(parameterSetIdentifierNode.asString()).isEqualTo("44");
