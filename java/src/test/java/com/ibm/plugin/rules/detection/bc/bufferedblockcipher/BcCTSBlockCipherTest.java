...
class BcCTSBlockCipherTest extends TestBase {
    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/bc/bufferedblockcipher/BcCTSBlockCipherTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("CTSBlockCipher");
        ...
        assertThat(modeNode.asString()).isEqualTo("CTS");
