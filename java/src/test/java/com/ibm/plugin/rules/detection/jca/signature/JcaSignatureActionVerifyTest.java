...
class JcaSignatureActionVerifyTest extends TestBase {

    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/jca/signature/JcaSignatureActionVerifyTestFile.java")
                .withChecks(this)
                .verifyIssues();
    }
    ...
    public void asserts(
        ...
        assertThat(value.asString()).isEqualTo("VERIFY");
