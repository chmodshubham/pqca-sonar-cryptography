...
class BcDigestingStateAwareMessageSignerTest extends TestBase {
    @Test
    void test() {
    ...
    public void asserts(
        ...
        if (findingId == 0) {
            ...
            assertThat(value02.asString()).isEqualTo("GMSSStateAwareSigner");
            ...
            assertThat(value0211.asString()).isEqualTo("256");
            ...
            // DigestSize under ExtendableOutputFunction under Signature
            INode digestSizeNode = extendableOutputFunctionNode.getChildren().get(DigestSize.class);
            assertThat(digestSizeNode).isNotNull();
            assertThat(digestSizeNode.getChildren()).isEmpty();
            assertThat(digestSizeNode.asString()).isEqualTo("256");
            ...
            INode digestSizeNode1 = messageDigestNode.getChildren().get(DigestSize.class);
