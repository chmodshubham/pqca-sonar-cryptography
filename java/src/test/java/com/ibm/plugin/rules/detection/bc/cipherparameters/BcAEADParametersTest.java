...
class BcAEADParametersTest extends TestBase {
    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/bc/cipherparameters/BcAEADParametersTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        INode tagLengthNode = blockCipherNode.getChildren().get(TagLength.class);
