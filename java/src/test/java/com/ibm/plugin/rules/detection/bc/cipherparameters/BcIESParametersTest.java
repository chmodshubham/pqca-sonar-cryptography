...
class BcIESParametersTest extends TestBase {
    @Test
    void test() {
    ...
    public void asserts(
        ...
        assertThat(value0_1_1.asString()).isEqualTo("256");

        if (findingId == 1) {
            DetectionStore<JavaCheck, Tree, Symbol, JavaFileScannerContext> store_1_1_1 =
                    getStoreOfValueType(KeySize.class, store_1_1.getChildren());
            assertThat(store_1_1_1.getDetectionValues()).hasSize(1);
            assertThat(store_1_1_1.getDetectionValueContext())
                    .isInstanceOf(AlgorithmParameterContext.class);
        ...
        assertThat(blockCipherNode1.asString()).isEqualTo(findingId == 1 ? "AES128" : "AES");
        ...
        INode tagLengthNode1 = blockCipherNode1.getChildren().get(TagLength.class);
        assertThat(tagLengthNode1).isNotNull();
        assertThat(tagLengthNode1.getChildren()).isEmpty();
        assertThat(tagLengthNode1.asString()).isEqualTo("256");
