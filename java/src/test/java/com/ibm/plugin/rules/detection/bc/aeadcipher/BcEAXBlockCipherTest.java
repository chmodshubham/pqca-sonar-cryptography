...
class BcEAXBlockCipherTest extends TestBase {
    @Test
    void test() {
        CheckVerifier.newVerifier()
                .onFile(
                        "src/test/files/rules/detection/bc/aeadcipher/BcEAXBlockCipherTestFile.java")
                .withChecks(this)
    ...
    public void asserts(
        ...
        assertThat(value0.asString()).isEqualTo("EAXBlockCipher");
        ...
        assertThat(modeNode.asString()).isEqualTo("EAX");
    }
}
