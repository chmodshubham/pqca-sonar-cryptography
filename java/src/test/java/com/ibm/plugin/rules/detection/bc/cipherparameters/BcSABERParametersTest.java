...
class BcSABERParametersTest extends TestBase {
    @Test
    void test() {
    ...
    public void asserts(
        ...
        assertThat(value0_1_1).isInstanceOf(KeySize.class);
        assertThat(value0_1_1.asString()).isEqualTo("512");
        ...
        assertThat(blockCipherNode3.asString()).isEqualTo("AES512");
        ...
        assertThat(keyLengthNode3.asString()).isEqualTo("512");
